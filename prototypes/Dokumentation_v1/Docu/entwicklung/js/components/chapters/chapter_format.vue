<template>
<div class="chapter" :id="idLink">

<!-- Mein Markdown Text -->
<mdToText :uniqueTitle="'formattest'">
# Test for Formats?
...
<!-- Meine Abbildungen / Interactive Modules -->
<abb></abb>
<abb2></abb2>
...
<script>
// Import Parts
import mdToText from '../parts/text.vue';
