...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"journal maskedlayer",style:({ clipPath: 'url(#path_' + _vm.journalData.id +')', top:_vm.journalData.y+'px', left:_vm.journalData.x+'px', height: _vm.journalData.height+'px', width: _vm.journalData.width+'px', background: _vm.journalData.background}),attrs:{"touch-action":"none","id":'layer_'+_vm.journalData.id}},[_vm._v("\njournal\n")])}
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"toolLayer"},[(_vm.Tool === 'Werkzeug01')?_c('meinWerkzeug',{staticClass:"maskedlayer",style:({ clipPath: 'url(#path_' + _vm.layerData.id +')', top:_vm.layerData.y+'px', left:_vm.layerData.x+'px', height: _vm.layerData.height+'px', width: _vm.layerData.width+'px'}),attrs:{"stouch-action":"none","toolData":{id: _vm.layerData.id, height:_vm.layerData.height,width:_vm.layerData.width}}}):_vm._e(),_vm._v(" "),(_vm.Tool === 'Werkzeug02')?_c('meinAnderesWerkzeug',{staticClass:"maskedlayer",style:({ clipPath: 'url(#path_' + _vm.layerData.id +')', top:_vm.layerData.y+'px', left:_vm.layerData.x+'px', height: _vm.layerData.height+'px', width: _vm.layerData.width+'px'}),attrs:{"touch-action":"none","toolData":{id: _vm.layerData.id, height:_vm.layerData.height,width:_vm.layerData.width}}}):_vm._e(),_vm._v(" "),(_vm.Tool === 'NoTool')?_c('div',{staticClass:"layer maskedlayer",style:({ clipPath: 'url(#path_' + _vm.layerData.id +')',top:_vm.layerData.y+'px', left:_vm.layerData.x+'px', height: _vm.layerData.height+'px', width: _vm.layerData.width+'px'}),attrs:{"touch-action":"none","id":'layer_'+_vm.layerData.id}}):_vm._e()],1)}
__vue__options__.staticRenderFns = []
  ...
  mounted: function mounted() {
    ...
    var meinWerkzeug = new p5(function (p5) {
      ...
      p5.setup = function () {
        ...
        canvas.style('-webkit-clip-path', 'url(#path_' + toolData.id + ')');
