...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.reload("data-v-086ac22e", __vue__options__)
  }
})()}
},{"./abbildungen/abb.vue":1,"./abbildungen/abb2.vue":2,"vue":9,"vue-hot-reload-api":8}],4:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"docu"},[_c('h1',[_vm._v(_vm._s(this.$store.state.name))]),_vm._v(" "),_vm._l((this.$store.state.chapters),function(item,index){return _c('Chapter',{key:index,attrs:{"chapterContent":item}})})],2)}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-2ce43e51"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
},{"./chapter.vue":3,"vue":9,"vue-hot-reload-api":8}],5:[function(require,module,exports){
'use strict';
