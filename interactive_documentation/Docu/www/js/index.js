...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("p a.btn {\n    display: block;\n    background: #75cab1;\n    border-radius: 360px;\n    color: #fff;\n    padding: 10px 30px 10px 30px;\n    width: fit-content;\n    margin-top: 23px;\n}")
;(function(){
'use strict';
